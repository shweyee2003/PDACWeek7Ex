        ...
        registerCall.enqueue(new Callback<RegisterResponse>() {
            ...
            public void onResponse(Call<RegisterResponse> call, Response<RegisterResponse> response) {
                ...
                if(registerResponse == null) {
                    UserEvent.FailedUserEvent event = new UserEvent.FailedUserEvent(response.message());
                    EventBus.getDefault().post(event);
                } else {
                    if(registerResponse.getCode()== MyanmarAttractionsConstants.RESPONSE_CODE_FAILED)
                    {
                        UserEvent.FailedUserEvent event = new UserEvent.FailedUserEvent(registerResponse.getMessage());
                        EventBus.getDefault().post(event);
                    }
                    else {
                        UserEvent.SuccessUserEvent event = new UserEvent.SuccessUserEvent(registerResponse.getLoginUser());
                        EventBus.getDefault().post(event);
                    }
            ...
            public void onFailure(Call<RegisterResponse> call, Throwable throwable) {
                UserEvent.FailedUserEvent event = new UserEvent.FailedUserEvent(throwable.getMessage());
                EventBus.getDefault().post(event);
            }
        });
    }
        ...
        loginCall.enqueue(new Callback<LoginResponse>() {
            ...
            public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                ...
                else
                {
                    ...
                    {
                        UserEvent.FailedUserEvent event = new UserEvent.FailedUserEvent(loginResponse.getMessage());
                        EventBus.getDefault().post(event);
                    }
                    else {
                        UserEvent.SuccessUserEvent event = new UserEvent.SuccessUserEvent(loginResponse.getLoginUser());
                        EventBus.getDefault().post(event);
                    }
